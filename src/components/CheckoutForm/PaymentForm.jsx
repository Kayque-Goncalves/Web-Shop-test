...
const PaymentForm = ({ checkoutToken, shippingData, prevStep, nextStep, onCaptureCheckout }) => {
    const handleSubmit = async  (event, elements, stripe) => {
        ...
        const { error, paymentMethod } = await stripe.createPeymentMethod({ type: 'card', card: cardElement })
        ...
        if(error) {
            ...
            const orderData = {
                ...
                custumer: { 
                    ...
                    laastname: shippingData.lastname, 
                ...
                shipping: { 
                    ...
                    country: shippingData.shippyngCountry
                },
